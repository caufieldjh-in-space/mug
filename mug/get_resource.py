...
# TODO: more resources!
RES_TYPES = {
    "address modifier": "address_modifiers.tsv",
    "animal": "animals.tsv",
...
def get_items(
    ...
    with res_file.open() as infile:
        ...
        sample = heapq.nlargest(count, infile, key=lambda L: random.random())
...
def get_mapped_ids(
    ...
    # TODO: allow this to take a header name as an arg
    #       so it can get any specified mapping
    ...
    with res_file.open() as infile:
        ...
        for line in infile:
            ...
            id_map[splitline[0]] = splitline[1]
